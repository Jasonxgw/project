...
class DingdianpsiderSpider(scrapy.Spider):
    name = 'dingdianpsider'
    # allowed_domains = ['https://www.x23us.com.html'] # 过滤爬取的域名



    start_urls = ['https://www.x23us.com/class/' + str(i) + '_1.html' for i in range(1, 10)]
